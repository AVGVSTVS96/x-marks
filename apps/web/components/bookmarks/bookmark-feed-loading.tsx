...
interface BookmarkFeedLoadingProps {
  initialViewMode?: ViewMode
}

export function BookmarkFeedLoading({
  initialViewMode,
}: BookmarkFeedLoadingProps = {}) {
  const { viewMode: storedViewMode } = useViewPrefs()
  const viewMode = initialViewMode ?? storedViewMode
